...
| 10 | Example app — composition root · canonical-slice demo · dogfooding | — | — |
| 11 (deferred) | Broad tests + PalTestSupport · reachability · streaming download-to-disk | — | — |

Tests today: smoke + MemoryCache + TokenProvider single-flight + interceptor-chain + Router + Loader.
